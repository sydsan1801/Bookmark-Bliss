...
const ViewBookDetails = () => {
    ...
    const handleFavourite=async()=>{
        try{
            const response=await axios.put("https://bookmark-bliss.vercel.app/api/v1/add-book-to-favourite",{},{headers})
    ...
    const handleCart=async()=>{
        try{
            const response=await axios.put("https://bookmark-bliss.vercel.app/api/v1/add-to-cart",{},{headers})
    ...
    const DeleteBook=async()=>{
        try{
            const response=await axios.delete("https://bookmark-bliss.vercel.app/api/v1/delete-book",{headers})
            toast.success(response.data.message)
            navigate("/all-books")
